...
// (qui vaut #f5c842, bleu, malgré son nom) : les pages légales demandent
// explicitement un or #f5c842, d'où l'usage de style inline ici plutôt que
...
export function LegalLayout({ title, showUpdatedDate = true, sections }: Props) {
  return (
    <div className="min-h-screen px-4 sm:px-8 py-10 sm:py-12" style={{ background: '#0a0f2e' }}>
